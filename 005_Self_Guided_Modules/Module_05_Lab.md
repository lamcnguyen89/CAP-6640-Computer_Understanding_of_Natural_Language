# Module 5 Self-Guided Lab: Neural Text Generation and Decoding Strategies

This lab is a self-directed, ungraded activity designed to help you operationalize the core concepts from Lectures 14–16. The goal is to move from theory to practice by experimenting with decoding algorithms, entropy control mechanisms, and generation dynamics in large language models.
