# Module 3 Self-Guided Lab: Language Modeling and Sequence-to-Sequence Models

This lab is a self-directed, ungraded activity designed to help you operationalize the core concepts from Lectures 8–10. The goal is to move from theory to practice by experimenting with decoding algorithms, entropy control mechanisms, and generation dynamics in large language models.
